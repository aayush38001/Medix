...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2017 at 10:41 AM
...
CREATE TABLE IF NOT EXISTS `aadhaar` (
  `aadhaar_id` varchar(15) NOT NULL,
  `aadhaar_first_name` varchar(15) NOT NULL,
  `aadhaar_last_name` varchar(20) NOT NULL,
  `aadhaar_date_of_birth` varchar(3) NOT NULL,
  `aadhaar_month_of_birth` varchar(3) NOT NULL,
  `aadhaar_year_of_birth` varchar(5) NOT NULL,
  `aadhaar_sex` varchar(2) NOT NULL,
  `aadhaar_address` varchar(50) NOT NULL,
  `aadhaar_city` varchar(15) NOT NULL,
  `aadhaar_state` varchar(20) NOT NULL,
  `aadhaar_pin_code` varchar(10) NOT NULL
...
INSERT INTO `aadhaar` (`aadhaar_id`, `aadhaar_first_name`, `aadhaar_last_name`, `aadhaar_date_of_birth`, `aadhaar_month_of_birth`, `aadhaar_year_of_birth`, `aadhaar_sex`, `aadhaar_address`, `aadhaar_city`, `aadhaar_state`, `aadhaar_pin_code`) VALUES
('112233445566', 'amit', 'mittal', '06', '06', '1995', 'm', '117 Madhuban Colony', 'dewas', 'Madhya pradesh', '455001');
...
('Sadasd', '3432234', 8989509860, 9039791469, '117, Madhuban Colony', 'amitarmittal@gmail.com', 0, '123456789'),
...
('Vidhya', 'Samad', 'Barpha', '0001-01-01', 'Female', 1234567890, 1234567891, '23455666', '123456567787', 'vidhya.samad@gmail.com', 'abcd12345', 83, 25, 4, 'A+', 'fdfd', 'kjdchbscg', 'Lic', 'lic@gmail.com', 1234567895, 'delhi', 'amargupta@gmail.com', '2017-04-02 08:00:02', 'apolloindore@gmail.com', 1, 1),
...
('Bharath', '', 'Subramanian', '1995-08-15', 'Male', 7583008885, 9893032723, 'Indore', 'ad1234', 'bharath.1581995@gmail.com', 'qwertyuiop', 180, 70, 22.5, 'B+', 'dust', 'lic1234', 'LIC', 'lic@gmail.com', 9425345491, 'Mumbai', 'amargupta@gmail.com', '2016-04-18 16:56:47', 'apolloindore@gmail.com', 0, 1),
...
--
ALTER TABLE `aadhaar`
 ADD PRIMARY KEY (`aadhaar_id`), ADD UNIQUE KEY `aadhaar_id` (`aadhaar_id`);
